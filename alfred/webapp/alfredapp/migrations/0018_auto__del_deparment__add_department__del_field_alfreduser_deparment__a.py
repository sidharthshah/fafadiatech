...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alfredapp_alfreduser', 'department',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2012, 5, 16, 0, 0), to=orm['alfredapp.Department']),
                      keep_default=False)
        ...
        # Deleting field 'Ticket.filattachment'
        db.delete_column('alfredapp_ticket', 'filattachment')

        # Adding field 'Ticket.attachment'
        db.add_column('alfredapp_ticket', 'attachment',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Ticket.dept'
        db.alter_column('alfredapp_ticket', 'dept_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alfredapp.Department'], null=True))
    def backwards(self, orm):
        ...
        db.add_column('alfredapp_alfreduser', 'deparment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2012, 5, 16, 0, 0), to=orm['alfredapp.Deparment']),
                      keep_default=False)
        ...
        # Adding field 'Ticket.filattachment'
        db.add_column('alfredapp_ticket', 'filattachment',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Ticket.attachment'
        db.delete_column('alfredapp_ticket', 'attachment')


        # Changing field 'Ticket.dept'
        db.alter_column('alfredapp_ticket', 'dept_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2012, 5, 16, 0, 0), to=orm['alfredapp.Deparment']))
    models = {
