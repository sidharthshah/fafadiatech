...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.package'
        db.add_column('alfredapp_customer', 'package',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alfredapp.CustomerPackage'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Ticket.package'
        db.delete_column('alfredapp_ticket', 'package_id')

    def backwards(self, orm):
        # Deleting field 'Customer.package'
        db.delete_column('alfredapp_customer', 'package_id')

        # Adding field 'Ticket.package'
        db.add_column('alfredapp_ticket', 'package',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alfredapp.CustomerPackage'], null=True, blank=True),
                      keep_default=False)
