...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Alfreduser.id'
        db.delete_column('alfredapp_alfreduser', 'id')

        # Adding field 'Alfreduser.user_ptr'
        db.add_column('alfredapp_alfreduser', 'user_ptr',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Alfreduser.id'
        db.add_column('alfredapp_alfreduser', 'id',
                      self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True),
                      keep_default=False)

        # Deleting field 'Alfreduser.user_ptr'
        db.delete_column('alfredapp_alfreduser', 'user_ptr_id')
