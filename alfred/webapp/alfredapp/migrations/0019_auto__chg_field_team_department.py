...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Team.department'
        db.alter_column('alfredapp_team', 'department_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alfredapp.Department'], null=True))
    def backwards(self, orm):

        # Changing field 'Team.department'
        db.alter_column('alfredapp_team', 'department_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['alfredapp.Department']))
    models = {
