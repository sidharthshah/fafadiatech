...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Customer.id'
        db.delete_column('alfredapp_customer', 'id')

        # Adding field 'Customer.alfreduser_ptr'
        db.add_column('alfredapp_customer', 'alfreduser_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=datetime.date.today, to=orm['alfredapp.Alfreduser'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'Team.id'
        db.delete_column('alfredapp_team', 'id')
    ...
    def backwards(self, orm):
        # Adding field 'Customer.id'
        db.add_column('alfredapp_customer', 'id',
                      self.gf('django.db.models.fields.AutoField')(default=datetime.datetime(2012, 5, 11, 0, 0), primary_key=True),
                      keep_default=False)
        ...
        db.add_column('alfredapp_team', 'id',
                      self.gf('django.db.models.fields.AutoField')(default=datetime.date.today, primary_key=True),
                      keep_default=False)
    ...
    models = {
        'alfredapp.alfreduser': {
            ...
            'deparment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['alfredapp.Deparment']"}),
