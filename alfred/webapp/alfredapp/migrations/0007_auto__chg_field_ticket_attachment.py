...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ticket.attachment'
        db.alter_column('alfredapp_ticket', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
    def backwards(self, orm):

        # Changing field 'Ticket.attachment'
        db.alter_column('alfredapp_ticket', 'attachment', self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2012, 5, 4, 0, 0), max_length=255))
    models = {
