...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('alfredapp_ticket', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alfredapp.TicketStatus'], null=True))

        # Changing field 'Ticket.package'
        db.alter_column('alfredapp_ticket', 'package_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alfredapp.CustomerPackage'], null=True))

        # Changing field 'Ticket.assignedto'
        db.alter_column('alfredapp_ticket', 'assignedto_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alfredapp.Team'], null=True))

        # Changing field 'Ticket.sla'
        db.alter_column('alfredapp_ticket', 'sla_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alfredapp.Sla'], null=True))
    def backwards(self, orm):

        # Changing field 'Ticket.status'
        db.alter_column('alfredapp_ticket', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['alfredapp.TicketStatus']))

        # Changing field 'Ticket.package'
        db.alter_column('alfredapp_ticket', 'package_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['alfredapp.CustomerPackage']))

        # Changing field 'Ticket.assignedto'
        db.alter_column('alfredapp_ticket', 'assignedto_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['alfredapp.Team']))

        # Changing field 'Ticket.sla'
        db.alter_column('alfredapp_ticket', 'sla_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['alfredapp.Sla']))
    models = {
